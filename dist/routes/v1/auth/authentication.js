...
const { register, registerAdmin, login, verifyEmail, forgetPassword, resetPassword, getTokenByEmail, getProfile, updateProfile, deleteProfile, changePassword, getAllUsers, activateAccount, deactivateAccount, uploadProfilePicture } = require('../../../controllers/auth/authController');
const { authenticationMiddleware } = require("../../../middlewares/authenticationMiddleware");
const { authorizationMiddleware } = require("../../../middlewares/authorizationMiddleware");
const bucket_1 = __importDefault(require("../../../middlewares/bucket"));
...
router.post('/profile/upload-picture', authenticationMiddleware(), bucket_1.default.single('file'), uploadProfilePicture);
