...
exports.CreateUserSocialDTO = void 0;
const joi_1 = __importDefault(require("joi"));
class CreateUserSocialDTO {
    constructor(names, email, profile_url) {
        this.names = names;
        this.email = email;
    ...
    static validate(data) {
        const schema = joi_1.default.object({
            ...
            profile_url: joi_1.default.string().uri().required(),
        });
...
exports.CreateUserSocialDTO = CreateUserSocialDTO;
